...
import { jamMode } from "@/lib/folliblancmusic/atomState"
import AnimateBackgroundTile from "@/components/folliblancMusic/animateBackgroundTile/AnimateBackgroundTile"
import Parallax from "@/components/folliblancMusic/parallax/Parallax"
import InfiniteScroll from "@/components/folliblancMusic/infiniteScroll/InfiniteScroll"
import Logo from "@/components/folliblancMusic/logo/Logo"
import History from "@/components/folliblancMusic/history/History"
import Shop from "@/components/folliblancMusic/shop/Shop"
            ...
            <main className={styles.main}>
                    ...
                    <Parallax className={styles.topImageCont} speed={-.2} style={{ position: "relative", width: "min(700px, 100%)", height: "450px", justifySelf: "center", top: "", display: "grid", gridTemplateRows: "auto 1fr auto", animation: `transformRotateY 1s 1600ms both, opacity 2500ms 1600ms both`, rotate: "-2deg" }}>
                        ...
                        <div style={{ overflow: "hidden", width: "100%" }}>
                            <Parallax speed={.2} style={{ position: "relative", width: "100%", height: "100%" }}>
                                <Image alt="bg" src={`/folliblancMusic/titleimage.jpg`} fill={true} sizes="(max-width: 600px) 100vw, 50vw" style={{ objectFit: "cover", overflow: "visible", objectPosition: "0 47%" }} />
                            </Parallax>
                        </div>
                ...
                <section>
                    <div style={{ display: "flex", flexWrap: "wrap", columnGap: "4rem", rowGap: "1rem", alignItems: "flex-start", justifyContent: "center", margin: "0 auto", maxWidth: "1000px" }}>
                        <Image alt="profile" width={1000} height={1000} src={"/folliblancMusic/about.jpg"} style={{ flex: "0 1 500px", width: "min(400px, 100%)", }} />
                ...
                <section style={{ padding: "4rem 0" }}>
                    <div className={styles.headingCont}>
                        ...
                        <Image alt="headerBackgroundImage" width={200} height={200} src={"/folliblancMusic/mic.png"} style={{ animation: "translate both linear", animationTimeline: "view()" }} />
                    </div>
