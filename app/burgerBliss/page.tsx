...
import ItemPicker from "@/components/burgerBliss/itemPicker/ItemPicker"
import Button1 from "@/components/burgerBliss/button1/Button1"
import { burgers, desserts, drinks, sides } from "@/lib/burgerBliss/products"
    ...
    return (
        <main className={`${styles.main}`}>
            <div className={styles.topCont}>
                <Image alt="burger" src={"/burgerBliss/burger.png"} fill={true} style={{ objectFit: "cover", }} sizes="100vw" priority={true} />
            ...
            <section>
                <div style={{ display: "flex", flexWrap: "wrap" }}>
                    <div style={{ flex: "1 1 266px", minHeight: "300px", position: "relative", }}>
                        <Image alt="food" src={"/burgerBliss/food.jpg"} fill={true} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" style={{ objectFit: "cover" }} />
                    </div>
            ...
            <section style={{ padding: "2rem 0 0 0" }}>
                <div style={{ display: "flex", flexWrap: "wrap" }}>
                    <div style={{ flex: "1 1 350px", minHeight: "300px", position: "relative", }}>
                        <Image alt="food" src={"/burgerBliss/food2.jpg"} fill={true} sizes="(max-width: 768px) 100vw, 50vw" style={{ objectFit: "cover" }} />
                    </div>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", color: "#fff", flexDirection: "row-reverse" }}>
                    <div style={{ flex: "1 1 350px", minHeight: "300px", position: "relative", }}>
                        <Image alt="food" src={"/burgerBliss/food3.png"} fill={true} sizes="(max-width: 768px) 100vw, 50vw" style={{ objectFit: "cover" }} />
                    </div>
            ...
            <section style={{ padding: "0rem 0rem", position: "relative", marginBlock: "2rem" }}>
                <Image alt="food" src={"/burgerBliss/food4.jpg"} width={1000} height={1000} style={{ objectFit: "cover", width: "100%", height: "400px" }} />
